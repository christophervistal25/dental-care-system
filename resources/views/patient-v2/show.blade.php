...
<head>
    ...
    <title>View Examination Record</title>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        <div class="profile_title">
                            <div class="col s12 center-align">
                                <div id="reportrange" class="pull-right white-text" style="padding : 10px; background:#3700B3;">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <div class="col-lg-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea readonly name="occlusion" id="occlusion" cols="30" rows="2" class="materialize-textarea">{{ $record->occlusion }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="periodontal_condition"
                                            id="periodontal_condition" class="form-control"
                                            value=" {{ $record->periodontal_condition }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="oral_hygiene" id="oral_hygiene"
                                            class="form-control" value="{{ $record->oral_hygiene }}">
                                    </div>
                                </div>

                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <input onclick="return {{ $record->denture_upper === 1 ? 'false;' : '' }}"
                                            type="checkbox"
                                            {{ $record->denture_upper === 1 ? 'checked' : 'disabled' }}
                                            name="denture_upper" id="denture_upper">
                                        <label for="denture_upper">Denture Upper</label>
                                        <input {{ $record->denture_upper === 1 ? 'readonly' : 'disabled' }}
                                            type="number" name="denture_upper_since" id="denture_upper_since"
                                            class="form-control" 
                                ...
                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                    <input onclick="return {{ $record->denture_lower === 1 ? 'false;' : '' }}"
                                        type="checkbox" {{ $record->denture_lower === 1 ? 'checked' : 'disabled' }}
                                        name="denture_lower" id="denture_lower">
                                    <label for="denture_lower">Denture Lower</label>
                                    <input {{ $record->denture_lower === 1 ? 'readonly' : 'disabled' }}
                                        type="number" name="denture_lower_since" id="denture_lower_since"
                                        class="form-control" 
                                ...
                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="abnormalities" id="abnormalities"
                                            class="form-control" value="{{ $record->abnormalities }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="general_condition"
                                            id="general_condition" class="form-control"
                                ...
                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="physician" id="physician"
                                            class="form-control" value="{{ $record->physician }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="nature_of_treatment"
                                            id="nature_of_treatment" class="form-control"
                                ...
                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="allergies" id="allergies"
                                            class="form-control" value="{{ $record->allergies }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="chronic_ailment"
                                            id="chronic_ailment" class="form-control"
                                ...
                                <div class="col-lg-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="drugs_taken" id="drugs_taken"
                                            class="form-control" value="{{ $record->drugs_taken }}">
                                    </div>
                                </div>
