...
<head>
    ...
    <!-- Page Title -->
    <title>{{ config('app.name') }} | Create your account</title>
            ...
            <div class="shadow-lg rounded p-4 p-sm-5 bg-white form mb-4">
                ...
                <form method="POST" action="{{ route('patient.auth.registerPatient') }}">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" name="mobile_no" class="form-control" placeholder="+639193693499"
                            value="{{ old('mobile_no') }}" />
                    </div>
                    <div class="my-3">
                    ...
                    <div class="d-grid">
                        <input class="btn btn-primary submit my-4" value="Create an account" type="submit">
                    </div>
                ...
                <!-- / /assets-v2/assets Form-->

                <p class="d-block text-center text-muted small">Already Register? <a
