...
<body class="">
    ...
    <section class="d-flex justify-content-center align-items-start vh-100 py-5 px-3 px-md-0">
        ...
        <div class="d-flex flex-column w-100 align-items-center">
            ...
            <!-- Logo-->
            <a href="{{ route('patient.auth.login') }}" class="d-table mt-5 mb-4 mx-auto">
            ...
            <div class="shadow-lg rounded p-4 p-sm-5 bg-white form">
                ...
                @endif
                <!-- Login Form-->
                <form class="mt-4" method="POST" action="{{ route('patient.auth.loginPatient') }}">
                ...
                <p class="d-block text-center text-muted small">New customer? <a
                        class="text-muted text-decoration-underline" href="{{ route('patient.auth.register') }}">Sign up
                        for an account</a>
                </p>
            </div>
        </div>
