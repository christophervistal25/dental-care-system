                    ...
                    <div class="dropdown ms-1">
                        ...
                        <ul class="dropdown-menu dropdown-md dropdown-menu-end" aria-labelledby="profileDropdown">
                            <li class="d-flex py-2 align-items-start">
                                <button
                                    class="btn-icon bg-primary-faded text-primary fw-bolder me-3">{{ strtoupper(substr(auth()->user()->name, 0, 1)) }}</button>
                            ...
                            <li><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('admin.account.setting') }}">Account Settings</a>
                            </li>
                ...
                <div class="pb-6">
                    ...
                    <ul class="list-unstyled mb-6">
                        ...
                        <li class="menu-item"><a class="d-flex align-items-center" href="#"
                                ...
                                aria-expanded="true" aria-controls="collapseMenuItemPages">
                                <span class="menu-icon">
                            ...
                            <div class="collapse show" id="collapseMenuItemPages" style="">
                                <ul class="submenu">
                        ...
                        <li class="menu-item"><a class="d-flex align-items-center" href="#"
                                ...
                                <span class="menu-link">Reports</span></a>
                            <div class="collapse show" id="collapseMenuItemPages" style="">
                                <ul class="submenu">
